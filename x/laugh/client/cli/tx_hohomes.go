...
func CmdSendHohomes() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "send-hohomes [src-port] [src-channel]",
		Short: "Send a hohomes over IBC",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msg := types.NewMsgSendHohomes(sender, srcPort, srcChannel, timeoutTimestamp)
