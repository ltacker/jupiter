...
func CmdSendHihimes() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "send-hihimes [src-port] [src-channel]",
		Short: "Send a hihimes over IBC",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msg := types.NewMsgSendHihimes(sender, srcPort, srcChannel, timeoutTimestamp)
