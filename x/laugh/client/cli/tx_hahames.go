...
func CmdSendHahames() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "send-hahames [src-port] [src-channel]",
		Short: "Send a hahames over IBC",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msg := types.NewMsgSendHahames(sender, srcPort, srcChannel, timeoutTimestamp)
